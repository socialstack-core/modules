...
namespace Api.Permissions
{
	...
	/// <summary>
	/// Checks if a field in an arg is less than a given value.
	/// </summary>
	public partial class FilterFieldLessThan: FilterNode
	{
		/// <summary>
		...
		public FilterFieldLessThan(Type type, string field)
		{
			Type = type;
			Field = field;
		...
		{
			return new FilterFieldLessThan(Type, Field)
			{
				Value = Value,
				ArgIndex = ArgIndex,
	...
	public partial class Filter
	{
		...
		/// <returns></returns>
		public Filter LessThanArg(System.Type type, string fieldName, int argIndex = 0)
		{
			return Add(new FilterFieldLessThan(type, fieldName)
			{
				AlwaysArgMatch = true,
				ArgIndex = argIndex
			});
		...
		/// <param name="argIndex"></param>
		/// <returns></returns>
		public Filter LessThan(System.Type type, string fieldName, object value, int argIndex = 0)
		{
			return Add(new FilterFieldLessThan(type, fieldName)
			{
				Value = value,
