...
namespace Api.Permissions
{
	...
	/// <summary>
	/// Checks if a field in an arg is less than or equal to a given value.
	/// </summary>
	public partial class FilterFieldLessThanOrEqual: FilterNode
	{
		/// <summary>
		...
		public FilterFieldLessThanOrEqual(Type type, string field)
		{
			Type = type;
			Field = field;
		...
		{
			return new FilterFieldLessThanOrEqual(Type, Field)
			{
				Value = Value,
				ArgIndex = ArgIndex,
	...
	public partial class Filter
	{
		...
		/// <summary>
		/// Adds a filter node which checks if the value at the given argIndex is less than or equal the given value.
		...
		/// <returns></returns>
		public Filter LessThanOrEqualArg(System.Type type, string fieldName, int argIndex = 0)
		{
