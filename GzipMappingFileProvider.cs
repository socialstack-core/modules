    ...
    public class GzipMappingFileProvider : IFileProvider
    {
        ...
        public IFileInfo GetFileInfo(string subpath)
        {
            foreach (var fileProvider in _fileProviders)
            {
                ...
                {
                    if (subpath.EndsWith(".css") || subpath.EndsWith(".js") || subpath.EndsWith(".html"))
                    {
		...
		/// </summary>
		public static string CacheControl = "max-age=315360000, public";
		...
		public static void OnPrepareResponse(StaticFileResponseContext context)
        {
            ...
            if (file.Name.EndsWith(".gz"))
            {
                ...
                }else if (file.Name.EndsWith(".html.gz"))
                {
