...
//tinymce.PluginManager.add("4r-fullscreen", ((e, t) => { const r = e.getContainer(), n = () => r?.classList.contains("fullscreen"), l = () => { n() ? (document.querySelectorAll("[inert]").forEach((e => { e.hasAttribute("data-keep-inert") ? e.removeAttribute("data-keep-inert") : e.removeAttribute("inert") })), document.querySelectorAll(".fullscreen-hidden-popover").forEach((e => { e.classList.remove("fullscreen-hidden-popover") }))) : function (e) { if (!e) return; let t = e; for (; t && t !== document.body;) { const e = t.parentElement; Array.from(e.children).forEach((e => { e !== t && (e.hasAttribute("inert") ? e.setAttribute("data-keep-inert", "true") : e.setAttribute("inert", ""), e.matches(":popover-open") && e.classList.add("fullscreen-hidden-popover")) })), t = e } }(r), r?.classList.toggle("fullscreen") }, o = e => (e.setActive(n()), () => { }); return e.ui.registry.addToggleButton("4r-fullscreen", { text: "Fullscreen", icon: "fullscreen", tooltip: "Toggle fullscreen view", onAction: l, onSetup: o }), e.ui.registry.addToggleMenuItem("4r-fullscreen", { text: "Fullscreen", icon: "fullscreen", onAction: l, onSetup: o }), { getMetadata: () => ({ name: "4 Roads Fullscreen plugin", url: "http://www.4-roads.com" }) } }));
