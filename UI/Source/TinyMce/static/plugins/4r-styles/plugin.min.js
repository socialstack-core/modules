...
(function () {
	...
	tinymce.PluginManager.add('4r-styles', (editor, url) => {
		...
		// helpers
		const BLOCK_TAGS = /^(ADDRESS|ARTICLE|ASIDE|BLOCKQUOTE|DD|DIV|DL|DT|FIELDSET|FIGCAPTION|FIGURE|FOOTER|FORM|H[1-6]|HEADER|HR|LI|MAIN|NAV|OL|P|PRE|SECTION|TABLE|UL)$/i;
		...
		function getClassItems() {
			return editor.options.get('fr_styles_classes') || [
				{ title: 'Uppercase2', value: 'fr-styles-uppercase' },
