ace.define("ace/ext/fr-beautify", ["require", "exports", "module", "ace/token_iterator"], function (e, t, n) {
	"use strict";
	...
	t.singletonTags = ["area", "base", "br", "col", "command", "embed", "hr", "html", "img", "input", "keygen", "link", "meta", "param", "source", "track", "wbr"],
		t.blockTags = ["react-component", "root-content", "article", "aside", "blockquote", "body", "div", "dl", "fieldset", "footer", "form", "head", "header", "html", "nav", "ol", "p", "script", "section", "style", "table", "tbody", "tfoot", "thead", "ul"],
...
(function () {
	ace.require(["ace/ext/fr-beautify"], function (m) {
