...
type EmbedReferrerPolicy = "no-referrer" | "no-referrer-when-downgrade" | "origin" | "origin-when-cross-origin" | "same-origin" | "strict-origin" | "strict-origin-when-cross-origin";
...
let _referrerPolicy: EmbedReferrerPolicy = (referrerPolicy || DEFAULT_REFERRER_POLICY) as EmbedReferrerPolicy;
	...
	*/
	...
	let wrapperStyle: React.CSSProperties = {
		...
		resize: _resize as "none" | "both" | "horizontal" | "vertical" | undefined
	};
