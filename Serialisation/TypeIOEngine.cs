...
namespace Api.SocketServerLibrary
{
	...
	public static class TypeIOEngine
    {
		...
		/// <returns></returns>
		public static PreGeneratedByteField AddField(TypeBuilder typeBuilder, List<PreGeneratedByteField> fields, string content)
		{
			return AddField(typeBuilder, fields, System.Text.Encoding.UTF8.GetBytes(content));
		}
