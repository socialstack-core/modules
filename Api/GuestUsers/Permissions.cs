	...
	public class Permissions
	{
		...
		public Permissions()
		{
			...
			Events.CapabilityOnSetup.AddEventListener((Context context, object source) =>
			{
				...
				Roles.Member.Grant("guestUser_create");
				Roles.Public.Grant("guestUser_create");
				Roles.Guest.Grant("guestUser_create");
				*/

				// Remove public viewing (as it's enabled by default):
				Roles.Guest.Revoke("guestUser_load", "guestUser_list");
				Roles.Public.Revoke("guestUser_load", "guestUser_list");
				Roles.Member.Revoke("guestUser_load", "guestUser_list");
