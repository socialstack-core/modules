	...
	public class Permissions
	{
		...
		public Permissions()
		{
			...
			Events.CapabilityOnSetup.AddEventListener((Context context, object source) =>
			{
				...
				Roles.Member.Grant("qrCode_create");
				Roles.Public.Grant("qrCode_create");
				Roles.Guest.Grant("qrCode_create");
				
				// Remove public viewing (as it's enabled by default):
				Roles.Guest.Revoke("qrCode_load", "qrCode_list");
				Roles.Public.Revoke("qrCode_load", "qrCode_list");
				Roles.Member.Revoke("qrCode_load", "qrCode_list");
				*/
