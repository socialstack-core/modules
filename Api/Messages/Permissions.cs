		...
		public Permissions()
		{
			...
			Events.CapabilityOnSetup.AddEventListener((Context context, object source) =>
			{
				...
				*/
				...
				Roles.Member.Grant("message_create");
				//Roles.Public.Grant("message_create");
				//Roles.Guest.Grant("message_create");
				/*
				// Remove public viewing (as it's enabled by default):
				Roles.Guest.Revoke("message_load", "message_list");
				Roles.Public.Revoke("message_load", "message_list");
				Roles.Member.Revoke("message_load", "message_list");
				*/
