 ...
 */
public class SidhPrivateKeyOpti {
     ...
     */
    public SidhPrivateKeyOpti(SikeParam sikeParam, Party party, BigInteger secret) {
     ...
     */
    public SidhPrivateKeyOpti(SikeParam sikeParam, Party party, byte[] bytes) {
        this.sikeParam = sikeParam;
        this.party = party;
     ...
     */
    public SidhPrivateKeyOpti(SikeParam sikeParam, Party party, string octets) {
        this.sikeParam = sikeParam;
        this.party = party;
        int sLength = sikeParam.GetMessageBytes();
     ...
     */
    public SidhPrivateKeyOpti(SikeParam sikeParam, Party party, BigInteger key, byte[] s) : this(sikeParam, party, key)
    {
     ...
     */
    public FpElementOpti GetFpElement() {
        BigInteger secret = ByteEncoding.FromByteArray(key);
        return sikeParam.GetFp2ElementFactoryOpti().Generate(secret).GetX0();
    }
    ...
    /// <returns></returns>
    public bool Equals(SidhPrivateKeyOpti that) {
