 ...
 */
public class SikeParamP751 : SikeParam {
	
    private ImplementationType implementationType;
    private Fp2ElementFactoryRef fp2ElementFactory;
    private MontgomeryAffine montgomery;
    private IsogenyAffine isogeny;

    private Fp2ElementFactoryOpti fp2ElementFactoryOpti;
    private MontgomeryProjective montgomeryOpti;
    private IsogenyProjective isogenyOpti;
    ...
    private Fp2ElementOpti a_Opti;
    private Fp2ElementOpti b_Opti;
    private int eA;
    private int eB;
    ...
    private Fp2PointAffine pA;
    private Fp2PointAffine qA;
    private Fp2PointAffine rA;
    private Fp2PointAffine pB;
    private Fp2PointAffine qB;
    private Fp2PointAffine rB;

    private Fp2PointProjective pA_Opti;
    private Fp2PointProjective qA_Opti;
    private Fp2PointProjective rA_Opti;
    private Fp2PointProjective pB_Opti;
    private Fp2PointProjective qB_Opti;
    private Fp2PointProjective rB_Opti;
    ...
    public SikeParamP751(ImplementationType implementationType) {
        ...
        p = new FpElementOpti(this, new ulong[]{
                0xFFFFFFFFFFFFFFFFL,
                0xFFFFFFFFFFFFFFFFL,
                0xFFFFFFFFFFFFFFFFL,
                0xFFFFFFFFFFFFFFFFL,
        ...
        p1 = new FpElementOpti(this, new ulong[]{
                0x0000000000000000L,
                0x0000000000000000L,
                0x0000000000000000L,
                0x0000000000000000L,
        ...
        px2 = new FpElementOpti(this, new ulong[]{
                0xFFFFFFFFFFFFFFFEL,
                0xFFFFFFFFFFFFFFFFL,
                0xFFFFFFFFFFFFFFFFL,
                0xFFFFFFFFFFFFFFFFL,
        ...
        pr2 = new FpElementOpti(this, new ulong[]{
                0x233046449DAD4058L,
                0xDB010161A696452AL,
                0x5E36941472E3FD8EL,
                0xF40BFE2082A2E706L,
        ...
        if (implementationType == ImplementationType.REFERENCE) {
            ...
            fp2ElementFactoryOpti = new Fp2ElementFactoryOpti(this);
            montgomeryOpti = new MontgomeryProjective();
            isogenyOpti = new IsogenyProjective();
        }
    ...
    /// </summary>
    /// <returns></returns>
    public Fp2ElementFactoryRef GetFp2ElementFactory() {
    ...
    /// </summary>
    /// <returns></returns>
    public Fp2ElementFactoryOpti GetFp2ElementFactoryOpti() {
        return fp2ElementFactoryOpti;
    }
    ...
    /// </summary>
    /// <returns></returns>
    public MontgomeryAffine GetMontgomery() {
        return montgomery;
    }
    ...
    /// </summary>
    /// <returns></returns>
    public IsogenyAffine GetIsogeny() {
        return isogeny;
    }
    ...
    /// </summary>
    /// <returns></returns>
    public MontgomeryProjective GetMontgomeryOpti() {
        return montgomeryOpti;
    }
    ...
    /// </summary>
    /// <returns></returns>
    public IsogenyProjective GetIsogenyOpti() {
        return isogenyOpti;
    }
    ...
    /// </summary>
    /// <returns></returns>
    public Fp2ElementOpti GetAOpti() {
        return a_Opti;
    }
    ...
    /// </summary>
    /// <returns></returns>
    public Fp2ElementOpti GetBOpti() {
        return b_Opti;
    }
    ...
    /// </summary>
    /// <returns></returns>
    public Fp2PointProjective GetPAOpti() {
        return pA_Opti;
    }
    ...
    /// </summary>
    /// <returns></returns>
    public Fp2PointProjective GetQAOpti() {
        return qA_Opti;
    }
    ...
    /// </summary>
    /// <returns></returns>
    public Fp2PointProjective GetRAOpti() {
        return rA_Opti;
    }
    ...
    /// </summary>
    /// <returns></returns>
    public Fp2PointProjective GetPBOpti() {
        return pB_Opti;
    }
    ...
    /// </summary>
    /// <returns></returns>
    public Fp2PointProjective GetQBOpti() {
        return qB_Opti;
    }
    ...
    /// </summary>
    /// <returns></returns>
    public Fp2PointProjective GetRBOpti() {
        return rB_Opti;
    }
    ...
    private readonly FpElementOpti p;
    ...
    private readonly FpElementOpti p1;
    ...
    private readonly FpElementOpti px2;
    ...
    private readonly FpElementOpti pr2;
    ...
    private void Init() {
        ...
        if (implementationType == ImplementationType.REFERENCE) {
            ...
            Fp2PointAffine PUBLIC_POINT_PA, PUBLIC_POINT_QA, PUBLIC_POINT_RA;
            Fp2PointAffine PUBLIC_POINT_PB, PUBLIC_POINT_QB, PUBLIC_POINT_RB;
            
            // A = 6, B = 1
            this.a = fp2ElementFactory.Generate(SideChannelUtil.BigIntegerSix);
            this.b = fp2ElementFactory.One();
            ...
            var PUBLIC_POINT_PA_X0 = new FpElementOpti(this,  new ulong[]{
                    0x884F46B74000BAA8L,
                    0xBA52630F939DEC20L,
                    0xC16FB97BA714A04DL,
                    0x082536745B1AB3DBL,
            ...
            var PUBLIC_POINT_PA_X1 = new FpElementOpti(this,  new ulong[]{
                    0xAEB78B3B96F59394L,
                    0xAB26681E29C90B74L,
                    0xE520AC30FDC4ACF1L,
                    0x870AAAE3A4B8111BL,
            ...
            var PUBLIC_POINT_QA_X0 = new FpElementOpti(this,  new ulong[]{
                    0x0F93CC38680A8CA9L,
                    0x762E733822E7FED7L,
                    0xE549F005AC0ADB67L,
                    0x94A71FDD2C43A4EDL,
            ...
            var PUBLIC_POINT_QA_X1 = new FpElementOpti(this,  new ulong[]{
                    0xECFF375BF3079F4CL,
                    0xFBFE74B043E80EF3L,
                    0x17376CBE3C5C7AD1L,
                    0xC06327A7E29CDBF2L,
            ...
            var PUBLIC_POINT_RA_X0 = new FpElementOpti(this,  new ulong[]{
                    0x1600C525D41059F1L,
                    0xA596899A0A1D83F7L,
                    0x6BFDEED6D2B23F35L,
                    0x5C7E707270C23910L,
            ...
            var PUBLIC_POINT_RA_X1 = new FpElementOpti(this,  new ulong[]{
                    0x9B794F9FD1CC3EE8L,
                    0xDB32E40A9B2FD23EL,
                    0x26192A2542E42B67L,
                    0xA18E94FCA045BCE7L,
            ...
            this.pA_Opti = new Fp2PointProjective(new Fp2ElementOpti(this, PUBLIC_POINT_PA_X0, PUBLIC_POINT_PA_X1), fp2ElementFactoryOpti.One());
            this.qA_Opti = new Fp2PointProjective(new Fp2ElementOpti(this, PUBLIC_POINT_QA_X0, PUBLIC_POINT_QA_X1), fp2ElementFactoryOpti.One());
            this.rA_Opti = new Fp2PointProjective(new Fp2ElementOpti(this, PUBLIC_POINT_RA_X0, PUBLIC_POINT_RA_X1), fp2ElementFactoryOpti.One());
            var PUBLIC_POINT_PB_X0 = new FpElementOpti(this,  new ulong[]{
                    0x85691AAF4015F88CL,
                    0x7478C5B8C36E9631L,
                    0x7EF2A185DE4DD6E2L,
                    0x943BBEE46BEB9DC7L,
            ...
            var PUBLIC_POINT_PB_X1 = new FpElementOpti(this,  new ulong[]{
                    0x0000000000000000L,
                    0x0000000000000000L,
                    0x0000000000000000L,
                    0x0000000000000000L,
            ...
            var PUBLIC_POINT_QB_X0 = new FpElementOpti(this,  new ulong[]{
                    0x8E7CB3FA53211340L,
                    0xD67CE54F7A05EEE0L,
                    0xFDDC2C8BCE46FC38L,
                    0x08587FAE3110DF1EL,
            ...
            var PUBLIC_POINT_QB_X1 = new FpElementOpti(this,  new ulong[]{
                    0x0000000000000000L,
                    0x0000000000000000L,
                    0x0000000000000000L,
                    0x0000000000000000L,
            ...
            var PUBLIC_POINT_RB_X0 = new FpElementOpti(this,  new ulong[]{
                    0xB56457016D1D6D1CL,
                    0x03DECCB38F39C491L,
                    0xDFB910AC8A559452L,
                    0xA9D0F17D1FF24883L,
            ...
            var PUBLIC_POINT_RB_X1 = new FpElementOpti(this,  new ulong[]{
                    0x58C967899ED16EF4L,
                    0x81998376DC622A4BL,
                    0x3D1C1DCFE0B12681L,
                    0x9347DEBB953E1730L,
            ...
            this.pB_Opti = new Fp2PointProjective(new Fp2ElementOpti(this, PUBLIC_POINT_PB_X0, PUBLIC_POINT_PB_X1), fp2ElementFactoryOpti.One());
            this.qB_Opti = new Fp2PointProjective(new Fp2ElementOpti(this, PUBLIC_POINT_QB_X0, PUBLIC_POINT_QB_X1), fp2ElementFactoryOpti.One());
            this.rB_Opti = new Fp2PointProjective(new Fp2ElementOpti(this, PUBLIC_POINT_RB_X0, PUBLIC_POINT_RB_X1), fp2ElementFactoryOpti.One());

            // A = 6, B = 1
            this.a_Opti = fp2ElementFactoryOpti.Generate(SideChannelUtil.BigIntegerSix);
            this.b_Opti = fp2ElementFactoryOpti.One();
    ...
    /// <param name="o"></param>
    /// <returns></returns>
    public bool Equals(SikeParam o) {
        if (this == o) return true;
        if (o == null || o.GetType() != typeof(SikeParamP751)) return false;
