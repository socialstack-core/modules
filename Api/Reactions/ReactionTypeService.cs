...
namespace Api.Reactions
{
	...
	public partial class ReactionTypeService : AutoService<ReactionType>
	{
		...
		public ReactionTypeService() : base(Events.ReactionType)
		{
			...
			InstallContent(new ReactionTypeBuilder() {
				Name = "Like",
				Key = "like",
				IconRef = "emoji:1F44D",
				GroupId = 1
			}, new ReactionTypeBuilder()
			{
				Name = "Dislike",
				Key = "dislike",
				IconRef = "emoji:1F44E",
		...
		/// <summary>
		/// Populates a ReactionType from a ReactionTypeBuilder.
		/// </summary>
		protected override async ValueTask PopulateContent(Context context, ReactionType content, ContentBuilder builder)
		{
			if (builder is ReactionTypeBuilder templateBuilder)
			{
				content.Name = templateBuilder.Name;
				content.GroupId = templateBuilder.GroupId;
				content.IconRef = templateBuilder.IconRef;
			}
		}
