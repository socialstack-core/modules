	...
	public class Permissions
	{
		...
		public Permissions()
		{
			...
			Events.CapabilityOnSetup.AddEventListener((Context context, object source) =>
			{
				...
				Roles.Member.Grant("interest_create");
				Roles.Public.Grant("interest_create");
				Roles.Guest.Grant("interest_create");
				
				// Remove public viewing (as it's enabled by default):
				Roles.Guest.Revoke("interest_load", "interest_list");
				Roles.Public.Revoke("interest_load", "interest_list");
				Roles.Member.Revoke("interest_load", "interest_list");
				*/
