	...
	public class Permissions
	{
		...
		public Permissions()
		{
			...
			Events.CapabilityOnSetup.AddEventListener((Context context, object source) =>
			{
				...
				Roles.Member.Grant("redirect_create");
				Roles.Public.Grant("redirect_create");
				Roles.Guest.Grant("redirect_create");
				
				// Remove public viewing (as it's enabled by default):
				Roles.Guest.Revoke("redirect_load", "redirect_list");
				Roles.Public.Revoke("redirect_load", "redirect_list");
				Roles.Member.Revoke("redirect_load", "redirect_list");
				*/
