	...
	public class Permissions
	{
		...
		public Permissions()
		{
			...
			Events.CapabilityOnSetup.AddEventListener((Context context, object source) =>
			{
				...
				Roles.Member.Grant("confirmation_create");
				Roles.Public.Grant("confirmation_create");
				Roles.Guest.Grant("confirmation_create");
				
				// Remove public viewing (as it's enabled by default):
				Roles.Guest.Revoke("confirmation_load", "confirmation_list");
				Roles.Public.Revoke("confirmation_load", "confirmation_list");
				Roles.Member.Revoke("confirmation_load", "confirmation_list");
				*/
