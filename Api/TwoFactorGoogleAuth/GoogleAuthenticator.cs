...
namespace Api.TwoFactorGoogleAuth
{
	...
	/// <summary>
	/// Handles Google authenticator 2FA.
	/// With thanks to https://stackoverflow.com/questions/6421950/is-there-a-tutorial-on-how-to-implement-google-authenticator-in-net-apps
	/// </summary>
	public class GoogleAuthenticator
	{
		...
		/// </summary>
		public string GeneratePin(byte[] key, long counter)
		{
