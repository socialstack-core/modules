	...
	public class Permissions
	{
		...
		public Permissions()
		{
			...
			Events.CapabilityOnSetup.AddEventListener((Context context, object source) =>
			{
				...
				Roles.Member.Grant("review_create");
				Roles.Public.Grant("review_create");
				Roles.Guest.Grant("review_create");
				
				// Remove public viewing (as it's enabled by default):
				Roles.Guest.Revoke("review_load", "review_list");
				Roles.Public.Revoke("review_load", "review_list");
				Roles.Member.Revoke("review_load", "review_list");
				*/
