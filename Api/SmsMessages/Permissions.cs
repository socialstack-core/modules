	...
	public class Permissions
	{
		...
		public Permissions()
		{
			...
			Events.CapabilityOnSetup.AddEventListener((Context context, object source) =>
			{
				...
				Roles.Member.Grant("smstemplate_create");
				Roles.Public.Grant("smstemplate_create");
				Roles.Guest.Grant("smstemplate_create");
				*/

				// Remove public viewing (as it's enabled by default):
				Roles.Guest.Revoke("smstemplate_load", "smstemplate_list");
				Roles.Public.Revoke("smstemplate_load", "smstemplate_list");
				Roles.Member.Revoke("smstemplate_load", "smstemplate_list");
