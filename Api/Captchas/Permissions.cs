	...
	public class Permissions
	{
		...
		public Permissions()
		{
			...
			Events.CapabilityOnSetup.AddEventListener((Context context, object source) =>
			{
				...
				Roles.Member.Grant("captcha_create");
				Roles.Public.Grant("captcha_create");
				Roles.Guest.Grant("captcha_create");
				
				// Remove public viewing (as it's enabled by default):
				Roles.Guest.Revoke("captcha_load", "captcha_list");
				Roles.Public.Revoke("captcha_load", "captcha_list");
				Roles.Member.Revoke("captcha_load", "captcha_list");
				*/
