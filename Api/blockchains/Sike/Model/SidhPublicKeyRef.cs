 ...
 */
public class SidhPublicKeyRef {

    private SikeParam sikeParam;

    private Fp2ElementRef px;
    private Fp2ElementRef qx;
    private Fp2ElementRef rx;
     ...
     */
    public SidhPublicKeyRef(SikeParam sikeParam, Fp2ElementRef px, Fp2ElementRef qx, Fp2ElementRef rx) {
     ...
     */
    public SidhPublicKeyRef(SikeParam sikeParam, byte[] bytes) {
        this.sikeParam = sikeParam;
     ...
     */
    public SidhPublicKeyRef(SikeParam sikeParam, string octets) {
        this.sikeParam = sikeParam;
        BigInteger prime = sikeParam.GetPrime();
        int primeSize = (prime.BitLength + 7) / 8;
    ...
    /// <returns></returns>
    public bool Equals(SidhPublicKeyRef that) {
