	...
	public class Permissions
	{
		...
		public Permissions()
		{
			...
			Events.CapabilityOnSetup.AddEventListener((Context context, object source) =>
			{
				...
				Roles.Member.Grant("siteDomain_create");
				Roles.Public.Grant("siteDomain_create");
				Roles.Guest.Grant("siteDomain_create");
				
				// Remove public viewing (as it's enabled by default):
				Roles.Guest.Revoke("siteDomain_load", "siteDomain_list");
				Roles.Public.Revoke("siteDomain_load", "siteDomain_list");
				Roles.Member.Revoke("siteDomain_load", "siteDomain_list");
				*/
