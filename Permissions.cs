	...
	public class Permissions
	{
		...
		public Permissions()
		{
			...
			Events.CapabilityOnSetup.AddEventListener((Context context, object source) =>
			{
				...
				Roles.Member.Grant("notification_create");
				Roles.Public.Grant("notification_create");
				Roles.Guest.Grant("notification_create");
				
				// Remove public viewing (as it's enabled by default):
				Roles.Guest.Revoke("notification_load", "notification_list");
