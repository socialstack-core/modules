	...
	public class Permissions
	{
		...
		public Permissions()
		{
			...
			Events.CapabilityOnSetup.AddEventListener((Context context, object source) =>
			{
				...
				Roles.Member.Grant("price_create");
				Roles.Public.Grant("price_create");
				Roles.Guest.Grant("price_create");
				
				// Remove public viewing (as it's enabled by default):
				Roles.Guest.Revoke("price_load", "price_list");
				Roles.Public.Revoke("price_load", "price_list");
				Roles.Member.Revoke("price_load", "price_list");
				*/
