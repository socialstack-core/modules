	...
	public class Permissions
	{
		...
		public Permissions()
		{
			...
			Events.CapabilityOnSetup.AddEventListener((Context context, object source) =>
			{
				...
				Roles.Member.Grant("legalText_create");
				Roles.Public.Grant("legalText_create");
				Roles.Guest.Grant("legalText_create");
				
				// Remove public viewing (as it's enabled by default):
				Roles.Guest.Revoke("legalText_load", "legalText_list");
				Roles.Public.Revoke("legalText_load", "legalText_list");
				Roles.Member.Revoke("legalText_load", "legalText_list");
				*/
