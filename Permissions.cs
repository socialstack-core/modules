	...
	public class Permissions
	{
		...
		public Permissions()
		{
			...
			Events.CapabilityOnSetup.AddEventListener((Context context, object source) =>
			{
				...
				Roles.Member.Grant("discount_create");
				Roles.Public.Grant("discount_create");
				Roles.Guest.Grant("discount_create");
				
				// Remove public viewing (as it's enabled by default):
				Roles.Guest.Revoke("discount_load", "discount_list");
				Roles.Public.Revoke("discount_load", "discount_list");
				Roles.Member.Revoke("discount_load", "discount_list");
				*/
