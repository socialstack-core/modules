	...
	public class Permissions
	{
		...
		public Permissions()
		{
			...
			Events.CapabilityOnSetup.AddEventListener((Context context, object source) =>
			{
				...
				Roles.Member.Grant("frequentlyAskedQuestion_create");
				Roles.Public.Grant("frequentlyAskedQuestion_create");
				Roles.Guest.Grant("frequentlyAskedQuestion_create");
				
				// Remove public viewing (as it's enabled by default):
				Roles.Guest.Revoke("frequentlyAskedQuestion_load", "frequentlyAskedQuestion_list");
