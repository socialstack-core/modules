	...
	public class Permissions
	{
		...
		public Permissions()
		{
			...
			Events.CapabilityOnSetup.AddEventListener((Context context, object source) =>
			{
				...
				Roles.Member.Grant("purchase_create");
				Roles.Public.Grant("purchase_create");
				Roles.Guest.Grant("purchase_create");
				
				// Remove public viewing (as it's enabled by default):
				Roles.Guest.Revoke("purchase_load", "purchase_list");
				Roles.Public.Revoke("purchase_load", "purchase_list");
				Roles.Member.Revoke("purchase_load", "purchase_list");
				*/
