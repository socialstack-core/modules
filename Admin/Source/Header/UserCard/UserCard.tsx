	...
	return (
		<>
			<Dropdown
				...
				label={
					<span>
						{`Hi ${user?.fullName || user?.username}`} <Icon type={'fr fa-user'}/>
					</span>
				}
			/>
			...
			{showImpersonationOpen &&
				...
				>
					<Alert variant="warning">
						...
						Selecting a user without administrative privileges will cause admin views
						to become inaccessible. To return to admin view, click the cog icon and
